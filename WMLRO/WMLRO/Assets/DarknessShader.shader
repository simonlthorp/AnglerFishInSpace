Shader "Custom/Lighting/Darkness Shader"
{
	Properties
	{
		_MainTex("Texture", 2D) = "white" {}
		_CharacterPosition("Char pos", vector) = (2,0,0,0)
		_CircleRadius("Flashlight size", Range(0,20)) = .7
		_RingSize("Ring size", Range(0,5)) = .7
